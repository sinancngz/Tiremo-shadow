/**
 * @file    mqtt_certs.h
 * @brief   Tiremo mutual-TLS certificate accessors (ESP32 NVS + MCU flash)
 */
...
/**
 * @brief  Replace RAM client cert + key with fleet-issued permanent PEMs.
 *         Root CA is left unchanged. Next Wifi_MqttCertsUpload2 uses these.
 */
